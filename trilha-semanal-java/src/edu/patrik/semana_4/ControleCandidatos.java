...
public class ControleCandidatos {
    ...
    static void entrandoEmContato(String candidato){
        ...
        do{
            //As variáveis do while precisam sofrer alterações para não ficar no loop infinito
            atendeu = atender();
    ...
    static void imprimirSelecionados(){
        ...
        System.out.println("Outra forma de impressão em Java: FOR EACH");
        for(String candidato : candidatos){
    ...
    static void analisarCandidato(double salarioPretendido){
        ...
        if(salarioBase > salarioPretendido)
            ...
            System.out.println("Ligar para o candidadto com a contra proposta");
        else
